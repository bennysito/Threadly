...
<nav class="bg-white shadow-sm">
  <div class="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-2">
    ...
    <div class="hidden md:flex items-center gap-6 ml-4">
      <!-- Notification, Message, Cart, Wishlist, Help Icons -->
      ...
      <a href="#" class="flex items-center hover:text-amber-500">
      ...
      <a href="#" class="flex items-center text-gray-700 hover:text-amber-500 font-medium">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <div class="relative">
        ...
        <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg z-10">
          <?php if ($isLoggedIn): ?>
              <div class="px-4 py-2 text-sm text-gray-600 italic font-medium">
    ...
    <div class="flex items-center gap-2 md:hidden">
      <button id="mobileBtn" class="flex items-center p-2 border rounded ">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
